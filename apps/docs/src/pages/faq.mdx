...
A request is a single SMS message sent or OTP code requested by a user. FYI - _otp validation is free_ 😊.
...
Dark mode is a premium feature for "simple" and "expert" tier users. If you're on the "free" plan, [upgrade](https://simpletext.dev/dashboard/billing) to access this feature.

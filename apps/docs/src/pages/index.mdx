...
<Callout>
Know what you're here for? Get started quickly and skip the crap [here](/getting-started/React-&-NextJS).
</Callout>

simpletext is a stupidly simple service to handle sms messages and otp verification. 
Oh yeah, and it's free - no credit card to sign up, and you get 100 messages for free every day.
...
UI to just get started - no bs, emails, spam or promotions. We just give talented developers
the tools to built awesome shit.
